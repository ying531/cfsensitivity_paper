...
write.csv(hat.gamma, paste(out_dir, "sens_pac_est_hgamma_diff_",diff_ind,"_set_",diff_cf,"_gamma_",Gamma_ind,"_seed_",seed,".csv",sep=''))
write.csv(true.ites, paste(out_dir, "sens_pac_est_ite_diff_",diff_ind,"_set_",diff_cf,"_gamma_",Gamma_ind,"_seed_",seed,".csv",sep=''))
write.csv(res, paste(out_dir, "sens_whp_est_res_diff_",diff_ind,"_set_",diff_cf,"_gamma_",Gamma_ind,"_seed_",seed,".csv",sep=''))